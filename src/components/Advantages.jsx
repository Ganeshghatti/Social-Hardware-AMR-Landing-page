...
export default function Advantages() {
  ...
  return (
    <section
      className="relative w-full flex flex-col mt-12 ml-2"
      id="whyus"
    >
      <SectionTitle title="Why choose us?" />
      <br />
      <Carousel>
        <CarouselContent className="w-full flex items-center gap-6 relative block min-h-[450px] mt-8 overflow-hidden">
          {/* Left card */}
  ...
  after:border-r-[300px] after:border-r-transparent"
        ...
        <div className="flex justify-center gap-6 absolute transform -translate-x-1/2 left-1/2 bottom-10">
          <CarouselPrevious
            onClick={prevSlide}
            className="text-[#ff6600] bg-white cursor-pointer hover:bg-white/90"
          />
          <CarouselNext
            onClick={nextSlide}
            className="text-[#ff6600] bg-white cursor-pointer hover:bg-white/90"
